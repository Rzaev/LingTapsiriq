...
namespace LingTapsiriq
{
    class Program
    {
        ...
        public static int SameLetter(string str1, string str2)
        {
            int counter = 0;
        ...
        static void Main(string[] args)
        {
            ...
            //var items = debtors
            //    .Where(d => (2021 - d.BirthDay.Year) > 26 && (2021 - d.BirthDay.Year) < 36)
            //    .OrderBy(d => d.FullName)
            //    .ToList();
            //foreach (var item in items)
            //{
            ...
            //var items = debtors
            //    .Where(d => d.FullName.Length >= 18 && d.Phone.CountOfSeven() >= 2)
            //    .ToList();
            //foreach (var item in items)
            //{
            //    Console.WriteLine(item);
            ...
            //int a;
            //var items = debtors
            //    .Where(d => d.Phone.NotContain('8'))
            //    .ToList();
            //foreach (var item in items)
            //{
            //    //str=item.FullName.Split(' ');
            //    // Console.WriteLine(str[1]);
            //    str = item.FullName.Split(' ');
            //    a = item.FullName.Split(' ').Length;
            //    for (int i = 1; i < a; i++)
            //    {
            //        Console.Write(str[i] + " ");
            //    }
            //    Console.Write(DateTime.Now.Year - item.BirthDay.Year + " ");
            //    Console.Write(item.Debt);
            //    Console.WriteLine();
            //}
            ...
            //    str = item.FullName.Split(' ');
            //    var items = debtors
            //        .Where(d => d.FullName.SameLetter(str[0], str[2]) >= 3)
            //        .OrderBy(d => d.FullName)
            //        .ToList();
            ...
            //var items = debtors
            //    .Where(d => d.FullName.ToUpper().Contains("S") && d.FullName.ToUpper().Contains("M") && d.FullName.ToUpper().Contains("I") &&
            //    d.FullName.ToUpper().Contains("L") && d.FullName.ToUpper().Contains("E"));
            ...
            //19)Tesevvur edek ki,butun borclari olanlar bugunden etibaren her ay 500 azn pul odeyecekler.Oz ad gunune kimi borcun oduyub qurtara bilenler

            //var items = debtors
            //    .FindAll(d => d.Debt.Pay(d.BirthDay.Month))
            //    .ToList();
            //foreach (var item in items)
            //{
            //    Console.WriteLine(item);
            ...
            //var result = debtors.GroupBy(d => d.BirthDay.Year)
            //    .Select(g => g.Key)
            //    .FirstOrDefault();
            ...
            //    str = item.FullName.Split(' ');
            //    var items = debtors
            //    .Where(d => d.FullName.SameLetter(str[0], str[2]) >= 3).ToList();
